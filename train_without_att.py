...
from keras.layers import Input, Lambda, RepeatVector, Flatten, LSTM
...
x = LSTM(512, consume_less='gpu', return_sequences=True)(x)
x = TimeDistributed(Dense(100, activation='relu'))(x)
output_ = TimeDistributed(Dense(args.vocabulary_size+2, activation='softmax'))(x)
